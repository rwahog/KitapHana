...
public class Main {
    public static void main(String[] args) throws IOException, SQLException, ClassNotFoundException {
        ...
        Statement statement = conn.createStatement()){
            ...
            statement.executeUpdate("create table if not exists books (id_document mediumint not null primary key, publisher varchar(1024) not null, year mediumint, edition_number mediumint, best_seller mediumint)");
