...
public class JournalArticle extends Document{
    ...
    public void save() throws SQLException {
        ...
        if(resultSet.next()){
            statement.executeUpdate("update ja set journal_name = '"+journal_name+"', date = '"+date+"', editors = '"+getEditorsAsString()+"' where id_document = '"+id+"'");
        }
        else{
            statement.executeUpdate("insert into ja (id_document, journal_name, date, editors) values('"+id+"', '"+journal_name+"', '"+date+"', '"+getEditorsAsString()+"')");
        }
    }
