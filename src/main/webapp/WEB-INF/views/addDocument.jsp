			...
			<form method="POST" name="main">
				<div class="form-group col-12">
					...
					<input type="text" class="form-control" id="title" name="title" placeholder="Title"
								 required="" value="${doc.getTitle()}" autofocus="">
				</div>
				<div class="form-group col-12">
					<label>Authors</label>
					<textarea type="text" class="form-control" name="authors" id="authors"
										value="${doc.getAuthorsAsString()}" placeholder="Authors"
										required=""></textarea>
				</div>
				<div class="form-group col-12">
				...
				<div class="form-group col-12">
					...
					<input type="text" class="form-control" name="keywords" id="keywords"
								 placeholder="Keywords" value="${doc.getKeywordsAsString()}" required="">
				</div>
					...
					<select id="type" class="form-control document-type" name="document-type">
						...
						<c:choose>
							<c:when test="${type == 'article'}">
								...
								<option value="article" selected style="background-color:black">Journal Article
								</option>
							</c:when>
							<c:when test="${type == 'av'}">
				...
				<div class="form-group col-4">
					...
					<input type="text" class="form-control" id="inputName" name="price"
								 value="${doc.getPrice()}" placeholder="Price" required="">
				</div>
				<div class="form-group col-4">
					<label for="inputSurname">Amount</label>
					<input type="number" class="form-control" id="inputSurname" name="amount"
								 value="${doc.getAmount()}" placeholder="Amount" required="">
				</div>
			</form>
			<c:set var="type" value="${doc.getType()}"/>
			<c:choose>
				...
				<div class="book-props row hidden" id="book">
					<div class="form-group col-3">
						...
						<input type="text" class="form-control" id="edition_number" name="edition_number"
									 value="${editionNumber}" placeholder="Edition number">
					</div>
					<div class="form-group col-4">
						<label for="publisher">Publisher</label>
						<input type="text" class="form-control" id="publisher" name="publisher"
									 value="${publisher}" placeholder="Publisher">
					</div>
					<div class="form-group col-3">
					...
					<div class="custom-control custom-checkbox my-1 mr-sm-2">
						<c:choose>
							<c:when test="${bestseller == 1}">
								<input type="checkbox" class="custom-control-input" name="bestseller" value="1"
											 checked id="customControlInline">
							</c:when>
							<c:otherwise>
								<input type="checkbox" class="custom-control-input" name="bestseller" value="1"
			...
			<form method="POST" name="article">
				<div class="ja-props row hidden" id="article">
					<div class="form-group col-5">
						...
						<input type="text" class="form-control" name="editors" value="${editors}" id="editors"
									 placeholder="Editors">
					</div>
					<div class="form-group col-4">
						<label for="journal_name">Journal name</label>
						<input type="text" class="form-control" name="journal_name" id="journal_name"
									 value="${journalName}" placeholder="Journal name">
					</div>
					<div class="form-group col-3">
						<label for="date">Date</label>
						<input type="text" class="form-control" name="date" value="${date}" id="date"
									 placeholder="Date">
					</div>
				</div>
			</form>
