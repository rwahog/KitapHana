		...
		<form class="form-singin col-12" action="/login" method="POST">
			...
			<c:choose>
				<c:when test='${requestScope["errorMessage"] != null}'>
					<input type="text" id="email" name="login" class="form-control" placeholder="Phone number"
								 required="" autofocus="" style="border-color: #76050f"><br>
					<input type="password" id="password" name="password" class="form-control"
								 placeholder="Password" required="" style="border-color: #76050f"><br>
					<p style="color: #cc1010; font-weight: bold; text-align: center"><%=request.getAttribute("errorMessage")%>
					</p>
				</c:when>
				<c:otherwise>
					<input type="text" id="email" name="login" class="form-control" placeholder="Phone number"
