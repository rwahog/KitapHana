			...
			<div class="document" itemscope
				...
				<div class="row">
					...
					<div class="col-md-8 document-info">
							...
							<tr>
								...
								<td>
									<div class="form-group col-4">
										<input type="number" max="7" min="0" class="form-control" id="number"
						...
						<form class="form-singin col-12" action="/document?id=${document.getId()}"
									method="POST">
							...
							<c:choose>
								<c:when test="${available > 0}">
									<div class="form-group">
										<button class="btn btn-primary btn-block col-12 col-md-3" type="submit"
														name="checkout" value="checkout">Check out
										</button>
									</div>
								</c:when>
								<c:otherwise>
									<div class="form-group">
										<button class="btn btn-block btn-primary col-12 col-md-3" type="submit"
														name="checkout" value="queue">Take a chance
										</button>
									</div>
								</c:otherwise>
							</c:choose>
