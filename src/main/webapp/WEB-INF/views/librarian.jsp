		...
		<div class="form-row">
			<div class="form-group col-4">
				...
				<input type="text" class="form-control" name="name" id="name" placeholder="Name"
							 value="${employee.getName()}" required="" autofocus="">
			</div>
			<div class="form-group col-4">
		...
		<div class="form-row">
			<div class="form-group col-6">
				...
				<input type="text" class="form-control" id=phone_number name="phone_number"
							 placeholder="Phone number" value="${employee.getPhoneNumber()}" required="">
			</div>
			<div class="form-group col-6">
		...
		<div class="form-row">
			<div class="form-group col-6">
				...
				<input type="text" class="form-control" id="password1" name="password1"
							 placeholder="Password" value="${employee.getPassword()}" required="">
			</div>
			<div class="form-group col-6">
				<label for="password2">Confirm your password</label>
				<input type="text" class="form-control" id="password2" name="password2"
							 placeholder="Confirm password" value="${employee.getPassword()}" required="">
			</div>
		</div>
