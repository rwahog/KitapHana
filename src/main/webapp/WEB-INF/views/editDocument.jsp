		...
		<div class="form-row">
			<div class="form-group col-12">
				...
				<input type="text" class="form-control" id="title" name="title" placeholder="Title"
							 value="${doc.getTitle()}" required="" autofocus="">
			</div>
			<div class="form-group col-12">
				<label for="authors">Authors</label>
				<input type="text" class="form-control" id="authors" name="authors"
							 value="${doc.getAuthorsAsString()}" placeholder="Keywords" required="">
			</div>
			<div class="form-group col-12">
			...
			<div class="form-group col-12">
				...
				<input type="text" class="form-control" id="keywords" name="keywords"
							 value="${doc.getKeywordsAsString()}" placeholder="Keywords" required="">
			</div>
				...
				<div class="book-props row hidden" id="book">
					...
					<div class="form-group col-4">
						...
						<input type="text" class="form-control" id="publisher" name="publisher"
									 value="${publisher}" placeholder="Publisher" required="">
					</div>
					<div class="form-group col-3">
			...
			<form method="POST">
				<div class="ja-props row hidden" id="article">
					<div class="form-group col-5">
						...
						<input type="text" class="form-control" id="editors" name="editors" value="${editors}"
									 placeholder="Editors" required="">
					</div>
					<div class="form-group col-4">
						<label for="journal_name">Journal name</label>
						<input type="text" class="form-control" id="journal_name" name="journal_name"
									 value="${journalName}" placeholder="Journal name" required="">
					</div>
					<div class="form-group col-3">
